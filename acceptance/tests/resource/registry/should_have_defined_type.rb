...
step "Start testing should_have_defined_type" do
  ...
  windows_agents.each do |agent|
    ...
    apply_manifest_on agent, manifest, apply_opts({'FACTER_FACT_PHASE' => '1'}, agent_exit_codes) do
    ...
    apply_manifest_on agent, manifest, apply_opts({'FACTER_FACT_PHASE' => '2'}, agent_exit_codes) do
