...
HERE
  ...
  context 'Start testing should_have_defined_type' do
    ...
    phase1_resources_created = [
      ...
      %r{Registry_value\[HKLM\\Software\\Vendor\\PuppetLabsTest\w+\\\\\].ensure: created},
      %r{Registry_value\[HKLM\\Software\\Vendor\\PuppetLabsTest\w+\\\\Setting1\].ensure: created},
      %r{Registry_value\[HKLM\\Software\\Vendor\\PuppetLabsTest\w+\\\\Setting2\].ensure: created},
      %r{Registry_value\[HKLM\\Software\\Vendor\\PuppetLabsTest\w+\\\\Setting3\].ensure: created},
    ]

    phase2_resources_changed = [
      %r{Registry_value\[HKLM\\Software\\Vendor\\PuppetLabsTest\w+\\\\\].data: data changed 'fact_phase=1' to 'fact_phase=2'},
      %r{Registry_value\[HKLM\\Software\\Vendor\\PuppetLabsTest\w+\\\\Setting1\].data: data changed 'fact_phase=1' to 'fact_phase=2'},
      %r{Registry_value\[HKLM\\Software\\Vendor\\PuppetLabsTest\w+\\\\Setting2\].data: data changed 'fact_phase=1' to 'fact_phase=2'},
